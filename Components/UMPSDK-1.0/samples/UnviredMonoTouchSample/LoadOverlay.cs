...
namespace UnviredIOSSample
{
	public class LoadingOverlay : UIView 
	{
		...
		public LoadingOverlay (RectangleF frame) : base (frame)
		{
			...
			activitySpinner.Frame = new RectangleF (centerX - ((float)(activitySpinner.Frame.Width)) / 2 ,(float)	centerY - ((float)activitySpinner.Frame.Height) - 20 ,(float)activitySpinner.Frame.Width ,(float) activitySpinner.Frame.Height);
